...
namespace DataControllers
{
	...
	/// </summary>
	internal sealed class DataControllers : StatelessService
	{
		public DataControllers(StatelessServiceContext context)
			: base(context)
		{
		}
		...
		protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
		{
			return new ServiceInstanceListener[]
			{
				new ServiceInstanceListener(serviceContext =>
					new KestrelCommunicationListener(serviceContext, "DataControllersEndpoint", (url, listener) =>
					{
						...
						return new WebHostBuilder()
									.UseKestrel(opt =>
									{
										int port = serviceContext.CodePackageActivationContext.GetEndpoint("DataControllersEndpoint").Port;
									...
									.ConfigureServices(
										services => ConfigureServices(services, serviceContext) )
		...
		private void ConfigureServices(IServiceCollection services, StatelessServiceContext serviceContext)
		{
			services.AddSingleton(serviceContext);
			var standardKernel = BootstrapHelper.LoadNinjectKernel();
			standardKernel.Rebind<StatelessServiceContext>().ToConstant(serviceContext);
			standardKernel.Rebind<ServiceContext>().ToConstant(serviceContext);
